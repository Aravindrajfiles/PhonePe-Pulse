...
st.set_page_config(
    page_title="Phonepe Pulse Data Visualization | By Aravind Raj M",
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={'About': """# This dashboard app is created by *Aravind Raj M*!
...
if selected == "Home":
    ...
    image = Image.open("D:\Aravind\project\PhonePe-Logo.png")
    st.image(image)
    st.video("D:\Aravind\project\youtube.py",start_time=0)
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/Aravindrajfiles")
        st.write("**:violet[My linkedln link]** ⬇️")
        st.write("https://www.linkedin.com/in/aravind-raj-069800280")